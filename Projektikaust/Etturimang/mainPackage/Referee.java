...
public class Referee {
	...
	private boolean isLegalAttack(){
		say("Rünnak");
		if (Math.abs(letterVal(th2)-letterVal(th1)) != 1) {say("Ründamata saab ainult 1 ruudu võrra diagonaalis.");return false;}
	...
	private boolean isLegalMove(){
		say("Tavakäik");
		if (letterVal(th1)!=letterVal(th2)) {say("Ründamata käia saab ainult sirgjooneliselt.");return false;}
