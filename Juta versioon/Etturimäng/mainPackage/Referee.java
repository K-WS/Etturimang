...
public class Referee {
	...
	//Lühendatud signatuuriga System.out.println() meetod. Vastab rohkem reaalsusele, sest kohtunik "ütleb" asju. 
	...
	////Järgnevad 7 meetodit on peameetodi sammud nende rakendamise järjekorras. 
	//
	//
	...
	private boolean isLegalMove()
	{
		...
		if (turn == 0 && (
				nr2 > nr1 && (
						(nr1 != 2 && nr2-nr1 == 1) || (nr2-nr1 <= 2 && nr1==2)) )) 
		{
			if (nr2 == 8) {
				endReached = true;
				say("Must võitis!");
		...
		if (turn == 1 && (
				nr1 > nr2 && (
						(nr1 != 7 && nr1-nr2 == 1) || (nr1-nr2 <= 2 && nr1==7)) ))
		{
			if (nr2 == 1) 
			{
				endReached = true;
	...
	//Meetod, mille abil kohtunikult küsitakse (põhiklassist), kas mäng on läbi. 
